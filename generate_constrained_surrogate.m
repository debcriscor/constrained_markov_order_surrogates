...
%this version of the code works with arrays of intergers
%0s and non-sucessive numbers are not allowed. Examples:
%[0,1,2,1,2] -> [1,2,3,2,3]
%[1,3,5,3,2,1] -> [1,3,4,3,2,1]

% Also, it doesn' work when each symbols occurrs only once. Example:
%[1,2], [1,2,3,4,5]
...
%estimate the probability of each symbol to be use in the sample part
...
for n=1:n_swaps
    ...
    rand_symbs = datasample(unique_symbs,2,'Weights',symbolFrequency);
